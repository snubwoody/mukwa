...
use mukwa_core::service::{Category, Service};
...
impl App {
    pub fn new() -> Result<Self> {
        ...
        let calendar_state = app.main_window.global::<ui::CalendarState>();
        setup_calendar_state(&calendar_state);
...
pub fn setup_calendar_state(calendar_state: &CalendarState) {
